import './onezone-datepicker-service.js';
import './style/onezone-datepicker.scss';
import './style/onezone-datepicker-variables.scss';
import template from './onezone-datepicker.html';

angular.module('app.ui.datepicker', ['ionic', 'onezone-datepicker.templates', 'onezone-datepicker.service'])
    .directive('uiDatepicker', ['$ionicGesture', 'onezoneDatepickerService', function ($ionicGesture, onezoneDatepickerService) {
        'use strict';
        ...
        function drawDatepicker(scope) {
            ...
            scope.createDatepicker = function (date) {
                ...
                scope.selectedPicker = createMonthParam;
